...
abstract class CronTask implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\CronTaskTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\CronTask object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\CronTask'), 0, $e);
        }
    }
     ...
     * @return $this|\App\Model\CronTask The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Model\CronTask
     */
     ...
     *
     * @return $this|\App\Model\CronTask The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\CronTask (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\CronTask Clone of current object.
     * @throws PropelException
     */

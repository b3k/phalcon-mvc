...
class TriggerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'upcheck.Map.TriggerTableMap';
     ...
     */
    const OM_CLASS = '\\Trigger';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'upcheck.Trigger';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('TRIGGER_INVOKE_ON', 'TriggerInvokeOn', 'CHAR', true, null, 'TEST_FALSE');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('User', '\\User', RelationMap::MANY_TO_ONE, array('user_id' => 'id_user', ), null, null);
        $this->addRelation('TriggerType', '\\TriggerType', RelationMap::MANY_TO_ONE, array('trigger_type_id' => 'id_trigger_type', ), null, null);
        $this->addRelation('TriggerLog', '\\TriggerLog', RelationMap::ONE_TO_MANY, array('id_trigger' => 'trigger_id', ), 'CASCADE', null, 'TriggerLogs');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Trigger) { // it's a model object

...
INSERT INTO `permissions` (`id`, `profile_id`, `resource`, `action`) VALUES
(1, 3, 'users', 'index'),
(2, 3, 'users', 'search'),
(3, 3, 'profiles', 'index'),
(4, 3, 'profiles', 'search'),
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `must_change_password`, `profile_id`, `banned`, `suspended`, `active`) VALUES
